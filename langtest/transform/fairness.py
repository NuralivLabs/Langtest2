...
class MinGenderF1Score(BaseFairness):
    ...
    min_score = TypedDict("min_score", {"male": float, "female": float, "unknown": float})

    TestConfig = TypedDict("TestConfig", {"min_score": Union[min_score, float]})
...
class MaxGenderF1Score(BaseFairness):
    ...
    max_score = TypedDict("max_score", {"male": float, "female": float, "unknown": float})

    TestConfig = TypedDict("TestConfig", {"max_score": Union[max_score, float]})
